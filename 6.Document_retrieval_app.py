...
# labels = [
#     '','Setup','Connectivity','Customer Support','Print Quality','Print Speed','Ink Supply and Cartridge',
#     'Ease of Use','Firmware','Business Services and Subscription','Paper Jam','Control Panel'
# ]
